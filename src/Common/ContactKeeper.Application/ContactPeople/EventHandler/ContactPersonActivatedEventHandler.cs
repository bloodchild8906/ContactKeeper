...
public class ContactPersonActivatedEventHandler : INotificationHandler<DomainEventNotification<ContactPersonCreatedEvent>>
{
    private readonly ILogger<ContactPersonActivatedEventHandler> _logger;
    private readonly IDomainEventService _eventService;

    public ContactPersonActivatedEventHandler(ILogger<ContactPersonActivatedEventHandler> logger, IDomainEventService eventservice)
    {
        _logger = logger;
